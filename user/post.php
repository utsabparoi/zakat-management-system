        ...
        <?php
            if (isset($_POST["submit2"]))
            {
              ...
              if ($total2 >= 0) {
               ...
               $sql = mysqli_query($link, "INSERT INTO donated_zakat VALUES ('', '$_POST[amount]', CURDATE(), (SELECT ID FROM user WHERE User_Name LIKE '$_SESSION[user]' AND Type LIKE 'Giver'), '$id', null, null)");
                if ($sql === TRUE) {
