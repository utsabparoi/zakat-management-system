...
mysqli_query($link, "UPDATE messages SET red = 'y' WHERE dusername LIKE '$_SESSION[receiver]'");
...
<table class="table table-bordered">
    ...
    <th>Messages</th>
                                ...
                                <!-- /page content -->
        <?php
        $res=mysqli_query($link, "SELECT * FROM messages AS M JOIN user AS U ON U.ID = M.User_ID WHERE susername LIKE '$_SESSION[receiver]' OR dusername LIKE '$_SESSION[receiver]' ORDER BY M.ID DESC");
...
?>
        ...
        <?php
            ...
            if (isset($_POST["submit1"]))
            {
                ...
                $sql = mysqli_query($link, "INSERT INTO messages VALUES('', '$_SESSION[receiver]', '$_POST[dusername]', '$_POST[title]', '$_POST[message]', 'n', (SELECT ID FROM user WHERE User_Name LIKE '$_SESSION[receiver]'))") or die(mysqli_error($link));
