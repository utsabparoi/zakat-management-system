...
<head>
    ...
    <body style="background:url('images/img3.jpg') no-repeat; background-size:cover;">
    <style type="text/css">
        body {
            color: white;
        }
...
<body class="login" style="margin-top: -20px;">
    ...
    <div class="login_wrapper">
            ...
            {
               $sql = mysqli_query($link, "INSERT INTO mosques_charity_foundation VALUES('', '$_POST[name]', '$_POST[type]', '$_POST[contact]', '$_POST[email]', '$_POST[streetaddress]', '$_POST[city]', '$_POST[country]', '$_POST[password]')");
                if ($sql === TRUE) {
