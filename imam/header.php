...
$tot=0;
$res=mysqli_query($link, "SELECT * FROM messages WHERE dusername LIKE '$_SESSION[imam]' AND red IN('n', 'n2')");
...
<head>
    ...
    <title><?php echo $_SESSION["imam"]; ?></title>
